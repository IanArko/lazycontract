...
def test_object_property():
    ...
    x = ObjectPropertyContract(
        a=dict(a="foo", b=1, c=2.3), b=TestContract(a="bar", b=4, c=5.6)
    )
...
def test_list_property():
    ...
    expected = dict(
        a=[1, "foo"],
        i=[1, 2, 3],
        t=[dict(a="foo", b=2, c=3.4), dict(a="bar", b=4, c=5.6)],
    )
...
def test_dict_property():
    ...
    x = DictPropertyContract(
        a={1: "foo"}, i={1: "2"}, t={"t": TestContract(a="bar", b=4, c=5.6)}
    )

    assert x.to_dict() == dict(
        a={1: "foo"}, i={1: 2}, t={"t": dict(a="bar", b=4, c=5.6)}
    )
...
def test_set_property():
    ...
    x = SetPropertyContract(
        a={1, "foo"}, i={1, "2", 2, "1", "2"}, t=[{"a": "aa"}, {"a": "aa"}]
    )
